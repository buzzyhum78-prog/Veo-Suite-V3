...
TOPICS_DATA = [
    ...
    "🌧️ Rain & Thunder (Mưa & Sấm)",
    "🌊 Ocean & Water (Sóng nước)",
    "🔥 Campfire & Fireplace (Lửa trại)",
    "❄️ Snow & Winter (Tuyết rơi)",
    "🧘 Meditation & Healing (Thiền/Chữa lành)",
    "🎧 Lofi & Study Music (Nhạc học tập)",
    "🔊 ASMR No Talking (Âm thanh không lời)",
    "--- 🧠 FORMAT 2: FACTS / KNOWLEDGE / EXPLAIN ---",
    "👽 Space & Universe (Vũ trụ)",
    "🌍 Geography & Maps (Địa lý)",
    "⏳ History & Ancient (Lịch sử)",
    "🦁 Animal Facts (Sự thật động vật)",
    "💡 Crazy Inventions (Phát minh lạ)",
    "🧠 Psychology & Human (Tâm lý học)",
    "💰 Finance & Crypto (Tài chính)",
    "--- 👻 FORMAT 3: STORY / NARRATIVE (Horror/Mystery) ---",
    "👻 Scary Stories (Chuyện ma)",
    "🕵️ True Crime (Vụ án)",
    "🏺 Unsolved Mysteries (Bí ẩn)",
    "👾 Creepypasta/Reddit Horror",
    "🚪 Liminal Spaces (Không gian lạ)",
    "--- 🐼 FORMAT 4: VISUAL COMPILATION (Cute/Funny) ---",
    "🐱 Cute Cats (Mèo)",
    "🐶 Funny Dogs (Chó)",
    "🐹 Hamsters/Capybara",
    "🦁 Wild Life (Động vật hoang dã)",
    "😂 Oddly Satisfying (Thỏa mãn thị giác)",
    "--- 🤖 FORMAT 5: TECH & FUTURE ---",
    "🤖 AI & Robots (Trí tuệ nhân tạo)",
    "🚀 Future Tech (Công nghệ tương lai)",
    "💻 Coding & Tools (Lập trình/Tool)",
    "--- 📖 FORMAT 6: TEXT & QUOTES ---",
    "💬 Reddit Confessions (Tâm sự)",
    "📜 Motivational Quotes (Động lực)",
